...
1. **OpenAI has an IPO coming.** When you're about to go public, you tighten your risk profile. Every infrastructure bet looks rosier when you're private and burning investor cash. Post-IPO, the calculus changes.

2. **The timing is convenient.** A "pause" creates leverage. If the UK government wants this to happen, it now has a clear incentive to clarify copyright rules, offer better energy deals, or otherwise sweeten the pot. OpenAI gets what it wants, or it gets a good excuse.

3. **Not much was actually built.** The announcements were heavy on vision, light on planning applications. Cobalt Park doesn't even have a current application for datacentre capacity. This was always explorative.
